...
import { registerForm, updateValue, submitForm, updateErrors, resetForm } from './store/actions';
...
class FormComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <form method={method} action={action} onSubmit={this.submit} className="width-full">
...
export default connect(({ forms }) => ({ forms }), mapActionsToProps)(FormComponent);
